...
<Warning>
This branch keeps BlueBubbles available through `channels.bluebubbles`; use [BlueBubbles](/channels/bluebubbles) if you want the BlueBubbles server path. Use this page for the imsg-based `channels.imessage` path, and start with [BlueBubbles and the imsg iMessage path](/announcements/bluebubbles-imessage) or [Coming from BlueBubbles](/channels/imessage-from-bluebubbles) when comparing or migrating.
</Warning>
...
- [BlueBubbles and the imsg iMessage path](/announcements/bluebubbles-imessage) — announcement and migration summary
