...
const TMP_FIXTURE_DIR = path.join(
  resolvePreferredOpenClawTmpDir({ osTmpdir: os.tmpdir() }),
...
function buildTelegramDmCallbackQueryUpdate(params: {
  ...
  delete update.callback_query.message.message_thread_id;
  delete update.callback_query.message.is_topic_message;
  return update as unknown as Record<string, unknown>;
}
