...
export function createBrowserTool(opts?: {
  ...
  return {
    ...
    description: [
      ...
      'Chrome extension relay needs a connected browser: user must open the Clawdi Browser popup and click "Connect Your Clawdi" to connect.',
        ...
        case "act": {
          ...
          try {
            ...
            if (msg.includes("404:") && msg.includes("tab not found") && profile === "chrome") {
              ...
              if (!tabs.length) {
                throw new Error(
                  'Browser extension is not connected. Ask the user to open the Clawdi Browser popup and click "Connect Your Clawdi", then retry.',
                  { cause: err },
                );
              }
              throw new Error(
